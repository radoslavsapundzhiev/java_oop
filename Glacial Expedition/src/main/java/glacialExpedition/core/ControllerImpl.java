...
public class ControllerImpl implements Controller {
    ...
    public String exploreState(String stateName) {
        ...
        List<Explorer> retiredExplorers = suitableExplorers.stream()
                .filter(e -> !e.canSearch()).collect(Collectors.toList());
        return String.format(ConstantMessages.STATE_EXPLORER, stateName, retiredExplorers.size());
    }
    ...
    public String finalResult() {
        ...
        for (Explorer explorer: explorerRepository.getCollection()) {
            String exhibitsString = explorer
                    .getSuitcase()
                    .getExhibits()
                    .stream()
            ...
            builder.append(String.format(ConstantMessages.FINAL_EXPLORER_SUITCASE_EXHIBITS, exhibitsString));
            builder.append(System.lineSeparator());
        }
